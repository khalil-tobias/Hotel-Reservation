...
public class UpdateRoom extends JFrame implements ActionListener {
    Choice ccustomerId;
    JTextField tfavailability, tfcleaningStatus, tfpendingAmount, tfroom, tfamountPaid;
    ...
    UpdateRoom() {
        ...
        tfavailability.setBounds(200, 120, 150, 25);
        add(tfavailability);
        ...
        tfcleaningStatus.setBounds(200, 160, 150, 25);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("images/eleventhImage.jpg"));
        ...
        if(ae.getSource() == check) {
            ...
            try {
                ...
                while(rs.next()) {
                    ...
                    tfcleaningStatus.setText(rs.getString("cleaningStatus"));
            ...
            try {
                Connection conn = new Connection();
                String query = "update room set availability = '" + available+ "', cleaningStatus = '" + status + "'where roomNumber = '" + room + "'where customerId = '" + customerId + "'";
